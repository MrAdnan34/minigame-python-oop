from Character import Petarunk, Dukun, WadimorBoy, CobuzierMan, BocilLatto
from Character import OrangDepresi, SupportSystem, DilanCepmek, ThePhoenix
from Character import test_voice1, test_voice2
import random
import time
